...
export default function AuthComp({ isSignup }: { isSignup: boolean }) {
  ...
  useEffect(() => {
    ...
    return (
      <div className="relative min-h-screen w-full flex items-center justify-center bg-gradient-to-b from-black to-gray-800 overflow-hidden px-4">
        ...
        <div
          data-aos="zoom-in"
          className="relative z-10 w-full max-w-md mx-auto bg-[#1a1a1a] border border-neutral-800 rounded-2xl shadow-lg p-8"
        >
